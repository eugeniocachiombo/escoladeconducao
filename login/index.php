...
<div class="principal">
    <div class="logo left-element" style="display: flex; align-items: center; justify-content: center; font-size: 50px;">
    ...
    <div class="form-login" style="display: flex;justify-content: center;align-items: center;flex-direction: column;">
        ...
        <div class="right-element" style="width: 100%; display: flex; align-items: center; justify-content: center;">
